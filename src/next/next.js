...
export const ViewModel = Map.extend({
  define: {
    ...
    /**
     * By default, request params will be in the format `{'date':{$gt: 'test'}, $limit: 1}`.
     * Use the gtKey attribute to change `$gt` to something else. Changing the
